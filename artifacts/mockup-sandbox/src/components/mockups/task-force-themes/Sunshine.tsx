  ...
  return (
    <div className="min-h-screen bg-green-50 font-sans text-slate-800 pb-12">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        {/* Stat Tiles — B's colors, C's aspect ratio */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-teal-100 rounded-3xl p-6 flex flex-col justify-between aspect-[4/3] relative overflow-hidden shadow-sm">
          ...
          <div className="bg-orange-100 rounded-3xl p-6 flex flex-col justify-between aspect-[4/3] relative overflow-hidden shadow-sm">
            <div className="bg-white/50 w-12 h-12 rounded-full flex items-center justify-center mb-4">
          ...
          <div className="bg-sky-100 rounded-3xl p-6 flex flex-col justify-between aspect-[4/3] relative overflow-hidden shadow-sm">
            <div className="bg-white/50 w-12 h-12 rounded-full flex items-center justify-center mb-4">
          ...
          <div className="bg-lime-100 rounded-3xl p-6 flex flex-col justify-between aspect-[4/3] relative overflow-hidden shadow-sm">
            <div className="bg-white/50 w-12 h-12 rounded-full flex items-center justify-center mb-4">
        ...
        {/* Two-column: Today's Focus sidebar + All Tasks wider */}
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">

          {/* Today's Focus — C's layout, B's accent colors */}
          ...
          {/* All Tasks — C's table layout, B's teal accents */}
                  ...
                  <tbody className="text-sm">
                    {[
                      ...
                      <tr key={i} className="border-b border-slate-50 last:border-0 hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td className={`px-6 py-4 font-medium ${task.done ? "text-slate-400 line-through" : "text-slate-800"}`}>
                          {task.title}
                        </td>
                        <td className="px-6 py-4">
